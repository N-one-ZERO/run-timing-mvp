export const REGIONS = {
  ...
  "경기도": [
    ...
    "안양시 만안구", "안양시 동안구", "안산시 상록구", "안산시 단원구",
    "화성시", "남양주시", "평택시", "의정부시", "시흥시", "파주시", "김포시", "광명시", "광주시", "군포시", "이천시", "양주시", "오산시", "구리시", "안성시", "포천시", "의왕시", "하남시", "여주시", "동두천시", "과천시", "양평군", "가평군", "연천군"
  ],
...
export const REGION_CENTERS = {
  ...
  "울산광역시": [35.5384, 129.3114], "세종특별자치시": [36.4800, 127.2890], "경기도": [37.2751, 127.0095],
  "강원특별자치도": [37.8228, 128.1555], "충청북도": [36.6357, 127.4917], "충청남도": [36.6588, 126.6728],
  "전북특별자치도": [35.8203, 127.1088], "전라남도": [34.8161, 126.4629], "경상북도": [36.5760, 128.5058],
  "경상남도": [35.2383, 128.6924], "제주특별자치도": [33.4890, 126.4983],
};

export const KNOWN_COORDS = {
  "서울특별시 강남구": [37.5172, 127.0473],
  "경기도 수원시 권선구": [37.2567, 126.9720],
};

export function getLocationName(region, district) {
  return region === district ? region : `${region} ${district}`;
}
